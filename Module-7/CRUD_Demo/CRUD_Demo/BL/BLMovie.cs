...
namespace CRUD_Demo
{
    public class database_Movie
    {
        ...
        /// <summary>
        /// Get movie data by Id using getMovieById
        /// </summary>
        /// <param name="id">id is a unique identifier</param>
        /// <returns>One record of Movie according to the id</retMovie
        ...
        /// <summary>
        /// Insert new Moive data using addMoive
        /// </summary>
        /// <param name="movieing">tutoring is an object of Moive</param>
